...
export default class ListaPet extends Component<any, props> {
            ...
            <div>
                ...
                <div className='container'>
                    <div className="collection">
                        <a className="collection-item" style={fontcolor} href="/pets">Pet 1</a>
                        <a className="collection-item" style={fontcolor} href="/pets">Pet 2</a>
                        <a className="collection-item" style={fontcolor} href="/pets">Pet 3</a>
                    </div>
                </div>
            </div>
        )
