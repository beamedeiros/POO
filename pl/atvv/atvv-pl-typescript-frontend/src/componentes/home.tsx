...
import shoppping from '../images/shopping.svg'
            ...
            <div>
                <nav className="">
                    <div className="nav-wrapper" style={backgroundColor} >
                        ...
                        <a style={botaoStyle} href="/compra">Compra</a>
                ...
                <div style={displayContent}>
                    <div className="row">
                        ...
                        <div className="col s2" style={card}>
                            <div className="card">
                                <div className="card-content">
                                    <img src={shoppping} style={imgStyle} />
                                    <a className="waves-effect waves-light btn" style={backgroundColor} href="/formularioCadastroCompra">Cadastrar Compras</a>
                                </div>
                            </div>
                        </div>
                    </div>
